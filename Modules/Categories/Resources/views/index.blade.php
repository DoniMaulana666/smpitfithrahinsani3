                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            @can('delete categories')
                                                                <button class="btn btn-sm btn-danger btn-delete" data-id="{{ $i->id }}" data-name="{{ $i->category_title }}"><i class="fas fa-trash"></i></button>
                                                            @endcan
                                                        </div>
                                                    </td>
                                                @endcanany
                ...
                <div class="modal-body">
                    <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <label>Judul</label>
                            <div class="input-group">
                                <input type="text" class="form-control @error('category_title') is-invalid @enderror" placeholder="Judul" name="category_title" value="{{ old('category_title') }}">
                                @error('name')
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('category_description') is-invalid @enderror" placeholder="Deskripsi" name="category_description" value="{{ old('category_description') }}">
                                @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('categories.destroy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
