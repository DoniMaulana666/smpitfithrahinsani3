                ...
                <div class="modal-body">
                    <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <label>Kelas</label>
                            <div class="input-group">
                                <select class="custom-select" name="grades_id">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('student_name') is-invalid @enderror"
                                    placeholder="Name" name="student_name" value="{{ old('student_name') }}">
                                @error('student_name')
                ...
                <div class="modal-body">
                    <form action="{{ route('students.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('student_name') is-invalid @enderror"
                                    placeholder="Masukkan Nama" name="student_name" value="{{ old('student_name') }}">
                                @error('student_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('students.destroy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
