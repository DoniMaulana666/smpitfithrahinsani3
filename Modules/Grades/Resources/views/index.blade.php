                                ...
                                <table class="table table-bordered table-hover datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Name</th>
                                            <th>Updated</th>
                                            @canany(['update grades', 'delete grades'])
                                                <th>Action</th>
                                            @endcanany
                                        </tr>
                                    </thead>
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('grades.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="input-group">
                            <label>Name</label>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('grades.destroy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
