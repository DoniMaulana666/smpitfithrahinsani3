                ...
                <div class="modal-body">
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('post_title') is-invalid @enderror"
                                    placeholder="Judul" name="post_title" value="{{ old('post_title') }}">
                                @error('post_title')
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('post_description') is-invalid @enderror"
                                    placeholder="Judul" name="post_description" value="{{ old('post_description') }}">
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('posts.destroy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
